...
Prises sur le build de production, avec les données de démonstration.
...
|---|---|
| `desktop-01-aujourdhui.png` | Aujourd'hui, rôle propriétaire : à traiter, en cours, tâches, terminé |
| `desktop-02-missions.png` | Missions : recherche, filtres, trois regroupements |
| `desktop-03-mission-vue-ensemble.png` | Détail d'une mission, onglet Vue d'ensemble |
...
| `desktop-06-nouvelle-mission.png` | Panneau de création, avec le résumé des permissions |
...
| `desktop-09-projet-technique.png` | Projet technique (Tao) |
...
| `desktop-18-role-lyes.png` | Aujourd'hui vu par Lyes, développeur |
