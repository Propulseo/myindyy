...
export const automations: Automation[] = [
    ...
    runs: [
      {
        ...
        durationMin: 52,
        attempts: 1,
        note: "Quatre demandes prioritaires repérées : faut-il les rappeler aujourd'hui ou attendre la relance ?",
        missionId: "m-250",
      },
  ...
  },
  {
    ...
    runs: [
      ...
      { id: "r-lot-208", at: minutesAgo(71), outcome: "ok", durationMin: 3, attempts: 1 },
      { id: "r-lot-207", at: minutesAgo(101), outcome: "ok", durationMin: 2, attempts: 1 },
    ],
